    ...
    public void addListenerOnButtonClick() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(check1.isChecked()){
                    result.append(getString(R.string.checkbox1_text) + " ");
                }
                if(check2.isChecked()){
                    result.append(getString(R.string.checkbox2_text) + " ");
                }
                if(check3.isChecked()){
                    result.append(getString(R.string.checkbox3_text) + " ");
                }
                if(check4.isChecked()){
                    result.append(getString(R.string.checkbox4_text) + " ");
                }
                if(check5.isChecked()){
                    result.append(getString(R.string.checkbox5_text));
                }
